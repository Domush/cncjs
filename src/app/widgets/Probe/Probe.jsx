        ...
        <div className="form-group">
          ...
          <div className="btn-toolbar" role="toolbar" style={{ marginBottom: 5 }}>
            <div className="btn-group btn-group-sm">
              <button
                type="button"
                className={classNames('btn', 'btn-default', { 'btn-select': probeAxis === 'Z' })}
              ...
              <button
                type="button"
                className={classNames('btn', 'btn-default', { 'btn-select': probeAxis === 'X' })}
              ...
              <button
                type="button"
                className={classNames('btn', 'btn-default', { 'btn-select': probeAxis === 'Y' })}
          ...
          <p className={styles.probeAxisDescription}>
            {probeAxis === 'Z' && <i>{i18n._('Probe Z Axis')}</i>}
            {probeAxis === 'X' && <i>{i18n._('Probe X Axis')}</i>}
            {probeAxis === 'Y' && <i>{i18n._('Probe Y Axis')}</i>}
          </p>
        </div>
        <div className="form-group">
