...
class ProbeWidget extends PureComponent {
  ...
  actions = {
    ...
    populateProbeCommands: () => {
      const { probeAxis, probeCommand, useTLO, probeDepth, probeFeedrate, touchPlateHeight, retractionDistance } =
        this.state;
  ...
  canClick() {
    ...
    if (controllerType === TINYG) {
      ...
      const states = [TINYG_MACHINE_STATE_READY, TINYG_MACHINE_STATE_STOP, TINYG_MACHINE_STATE_END];
