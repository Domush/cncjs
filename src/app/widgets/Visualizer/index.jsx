    ...
    return (
      <Widget borderless>
        ...
        >
          ...
          {showVisualizer && state.gcode.displayMessage && <GCodeMessage message={state.gcode.message} />}
          {showVisualizer && state.gcode.displayName && <GCodeName name={state.gcode.name} />}
          {showNotifications && (
            <Notifications
